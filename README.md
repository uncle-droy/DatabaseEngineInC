...
ROWDELETE: Delete a particular column of data or row of data or the selected table or the opened database

Commands and features yet to come:
Edit a particular cell data
